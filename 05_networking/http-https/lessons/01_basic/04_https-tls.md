...
| **TLS 1.2** ⭐ | 2008 | Phổ biến nhất (~95% traffic) |
| **TLS 1.3** ⭐ | 2018 | Modern, nhanh hơn, ~60% top sites |
...
- **Issued cert**: ~5 triệu mỗi ngày 2026
- **Coverage**: ~60% web traffic dùng cert Let's Encrypt
