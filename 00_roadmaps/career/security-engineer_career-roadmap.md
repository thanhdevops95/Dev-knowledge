...
| --- | --- |
| **Stage 1: Nền tảng bảo mật** | Làm chủ Linux shell, phân tích các gói tin mạng, viết script Python |
| **Stage 2: Bảo mật ứng dụng Web** | Hiểu rõ và biết cách vá 10 lỗ hổng bảo mật hàng đầu của OWASP |
| **Stage 3: Mật mã & Xác thực** | Tự thiết kế luồng JWT Auth an toàn, hiểu cơ chế mã hóa AES/RSA |
| **Stage 4: Pentest cơ bản** | Sử dụng Burp Suite đánh giá an toàn hệ thống, tham gia các lab CTF |
| **Stage 5: Cloud & Container Security** | Quét lỗ hổng image Docker, cấu hình AWS IAM Least Privilege |
| **Stage 6: Capstone & Chứng chỉ** | Hoàn thành báo cáo đánh giá bảo mật, thi đỗ chứng chỉ Security+ |

---

## ⚙️ Stage 1 — Nền tảng cốt lõi (Foundations)
...
## 🕸️ Stage 2 — Bảo mật ứng dụng (OWASP Top 10)
...
## 🔒 Stage 3 — Mật mã học & Xác thực người dùng
...
## 💥 Stage 4 — Kỹ thuật kiểm thử xâm nhập (Pentest Basics)
...
## ☁️ Stage 5 — Bảo mật đám mây Cloud & Container
...
## 🚀 Stage 6 — Capstone Project & Chứng chỉ bảo mật
