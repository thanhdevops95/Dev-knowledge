...
|---|---|---|
| **Stage 1: Toán & Python cơ bản** | 2-3 tháng | Sử dụng thành thạo NumPy, Pandas, hiểu ma trận và đạo hàm |
| **Stage 2: EDA & Thống kê** | 2 tháng | Vẽ biểu đồ trực quan hóa dữ liệu, chạy thử nghiệm A/B Testing |
| **Stage 3: Machine Learning truyền thống** | 3 tháng | Xây dựng các mô hình phân loại (Classification) và dự báo (Regression) |
| **Stage 4: Học sâu cơ bản (Deep Learning)** | 2 tháng | Xây dựng mạng nơ-ron đơn giản bằng PyTorch để phân loại ảnh |
| **Stage 5: Dự án Capstone & Business** | 2 tháng | 2-3 dự án hoàn chỉnh dạng interactive web app, thuyết trình insight |

---

## 📐 Stage 1 — Toán học & Lập trình Python (2-3 tháng)
...
## 📊 Stage 2 — EDA & Thống kê thực chiến (2 tháng)
...
## 🤖 Stage 3 — Học máy truyền thống (Classical ML) (3 tháng)
...
## 🧠 Stage 4 — Học sâu cơ bản (Deep Learning Basics) (2 tháng)
...
## 🚀 Stage 5 — Dự án Capstone & Kể chuyện dữ liệu (2 tháng)
...
- **Dự báo nhu cầu hàng tồn kho (Sales Forecasting):** Sử dụng thuật toán chuỗi thời gian (Time Series như Prophet, ARIMA) để dự báo doanh số bán hàng của chuỗi siêu thị trong 3 tháng tới, giúp tối ưu hóa chi phí lưu kho.
