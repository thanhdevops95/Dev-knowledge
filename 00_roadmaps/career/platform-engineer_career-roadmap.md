...
| --- | --- |
| **Stage 1: Nền tảng DevOps & K8s Deep** | Làm chủ nâng cao Kubernetes, viết Custom Resource Definitions (CRDs) |
| **Stage 2: Quy trình GitOps** | Đồng bộ hóa tự động K8s cluster thông qua ArgoCD hoặc Flux |
| **Stage 3: Cổng dịch vụ IDP** | Dựng thành công Service Catalog trung tâm quản lý mọi microservices |
| **Stage 4: Golden Paths & Templates** | Viết mẫu template tự động khởi tạo và cấu hình dự án chỉ bằng 1 PR |
| **Stage 5: Dự án Capstone** | 1 hệ thống IDP hoàn chỉnh cho phép dev tự đăng ký và deploy tự trị |

---

## ☸️ Stage 1 — DevOps & Kubernetes Deep
...
## 🏛️ Stage 3 — Cổng dịch vụ Internal Developer Platform
...
## 📐 Stage 4 — Đường đi trải vàng (Golden Paths) & Templates
