...
| --- | --- |
| **Stage 1: Nền tảng DevOps & K8s** | Vững vàng Docker, Kubernetes, Linux nâng cao và mạng máy tính |
| **Stage 2: Observability (Đo lường)** | Dựng thành công hệ thống thu thập Metrics, Logs, Traces cho ứng dụng |
| **Stage 3: SLO & Ứng phó sự cố** | Định nghĩa SLO, thiết lập cảnh báo theo tốc độ tiêu hao (Burn Rate) |
| **Stage 4: Hiệu năng & Chaos** | Profile code tìm điểm nghẽn, giả lập sập mạng, sập node để kiểm chứng |
| **Stage 5: Dự án Capstone** | 1 nền tảng Observability + Incident Management tự động hoàn chỉnh |

---

## ⚙️ Stage 1 — Nền tảng DevOps & Kubernetes
...
## 📊 Stage 2 — Làm chủ Observability (3 Trụ Cột)
...
## 🎯 Stage 3 — Chỉ số ổn định (SLO) & Ứng phó sự cố
...
## 💥 Stage 4 — Tối ưu hiệu năng & Kỹ thuật hỗn loạn (Chaos)
