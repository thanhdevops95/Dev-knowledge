...
|---|---|---|
| **Stage 1: C# & Unity Basics** | 2 tháng | Làm chủ giao diện Unity Editor, viết script di chuyển vật thể cơ bản |
| **Stage 2: Lập trình Game 2D** | 2 tháng | Hoàn thành game 2D Platformer có quái vật AI, lưu màn chơi |
| **Stage 3: Lập trình Game 3D** | 2 tháng | Xây dựng game 3D góc nhìn thứ ba, có chiến đấu và NavMesh AI |
| **Stage 4: Polish & Game Feel** | 2 tháng | Tích hợp menu UI, âm thanh không gian, camera shake mượt mà |
| **Stage 5: Multiplayer & Network** | 1-2 tháng | Xây dựng game 2 người chơi co-op qua mạng LAN sử dụng Netcode |
| **Stage 6: Đóng gói & Phát hành** | 2-3 tháng | Tối ưu hóa FPS, đóng gói game chạy trên PC/Web, upload lên itch.io |

---

## ⚙️ Stage 1 — C# & Unity Basics (2 tháng)
...
## 👾 Stage 2 — Phát triển Game 2D (2 tháng)
...
## 🧱 Stage 3 — Lập trình Game 3D (2 tháng)
...
## 🎨 Stage 4 — Mài giũa game (Polish & Game Feel) (2 tháng)
...
## 🌐 Stage 5 — Multiplayer & Networking (1-2 tháng)
...
## 🚀 Stage 6 — Đóng gói & Phát hành Game (Capstone) (2-3 tháng)
