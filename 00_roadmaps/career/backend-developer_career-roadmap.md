...
|---|---|---|
| **Stage 1: Nền tảng (Foundations)** | 1-2 tháng | Làm quen dòng lệnh Linux, giao thức HTTP và Git workflow chuyên nghiệp |
| **Stage 2: Viết REST API** | 2 tháng | Xây dựng được REST API CRUD chạy local, validate dữ liệu đầu vào |
| **Stage 3: Database & Cache** | 2 tháng | Thiết kế CSDL quan hệ Postgres tốt, tích hợp Redis cache tăng tốc |
| **Stage 4: Sẵn sàng Production** | 2 tháng | Tích hợp JWT Token bảo mật, viết unit test, đóng gói Docker và deploy |
| **Stage 5: Dự án Capstone** | 1-2 tháng | 1 dự án Backend Portfolio hoàn chỉnh chạy live trên internet |
...
## 💻 Stage 2 — Làm chủ Framework & Viết REST API (2 tháng)
...
## 🗄️ Stage 3 — Cơ sở dữ liệu & Caching (2 tháng)
...
## 🛡️ Stage 4 — Sẵn sàng cho Production (2 tháng)
