...
- [ ] Hiểu Vector Search & Embeddings là gì? là gì và tại sao nó quan trọng
- [ ] Biết các khái niệm cốt lõi và thuật ngữ chính
- [ ] Hiểu khi nào nên sử dụng Vector Search & Embeddings là gì?
...
> - 📚 Tài liệu chính thức của Vector Search & Embeddings là gì?
