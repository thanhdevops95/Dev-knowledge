...
Sau bộ Git ([các bài học cơ bản](../git/lessons/01_basic/)), bạn đã quen với `git init`, `commit`, `branch`. Sếp bảo *"push lên GitHub đi"*. Bạn vào github.com:
...
> 💡 Nếu lỡ commit secret: rotate secret NGAY, dùng `git filter-repo` xoá khỏi history. Xem [Git — Undo + Recovery](../git/lessons/03_advanced/00_undo-and-recovery.md).
...
### ❌ Cạm bẫy: Mất phone + recovery code → mất account
...
### ❌ Cạm bẫy: Commit với git config sai email
...
### ❌ Cạm bẫy: Push thẳng `main`, không qua PR
...
### ❌ Cạm bẫy: PAT có scope quá rộng + không expire
...
### ❌ Cạm bẫy: GitHub Pages không deploy
...
- 🎓 [Git — Undo + Recovery](../git/lessons/03_advanced/00_undo-and-recovery.md) — fix khi lỡ commit secret
...
- 🛠️ [GitHub Desktop](./github-desktop.md) — GUI nếu không thích CLI
