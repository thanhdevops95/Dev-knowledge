...
### ❌ Cạm bẫy: Quá tin GitLab Auto DevOps
...
### ❌ Cạm bẫy: Self-host CE cho team nhỏ
...
### ❌ Cạm bẫy: Mirror GitHub repo → GitLab nhưng CI fail
...
### ❌ Cạm bẫy: Quên Protected variables trong CI
...
- 🎓 [Git lessons](../git/lessons/01_basic/) — Git concept (cùng dùng cho GitLab)
