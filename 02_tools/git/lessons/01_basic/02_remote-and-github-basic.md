...
- [ ] Kết nối thành công Local Git với GitHub bằng 2 phương thức xác thực phổ biến (gh CLI, SSH)
...
Vì lý do an ninh, GitHub không cho phép bạn đẩy code ẩn danh. Bạn phải chứng minh *"Tôi chính là chủ sở hữu của tài khoản này"*. Có 2 phương thức xác thực phổ biến nhất hiện nay (ngoài ra còn Personal Access Token qua HTTPS — dùng khi không setup SSH):
...
- **v2.0.1 (13/06/2026)** — Sửa lỗi nhất quán: bài chỉ trình bày 2 phương thức xác thực (gh CLI, SSH) — đổi "3 phương thức" → "2", ghi chú PAT/HTTPS là phương án thứ 3.
