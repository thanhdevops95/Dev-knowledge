...
## 🎯 Hướng dẫn làm bài
Đọc kỹ từng câu hỏi dưới đây, tự suy nghĩ câu trả lời trong đầu hoặc viết ra giấy, sau đó nhấn vào phần **💡 Xem giải thích** để đối chiếu kết quả và lĩnh hội những đúc kết tri thức sâu sắc nhất.
...
-   ⬅️ Quay lại bài học: [Remote, origin & xác thực GitHub](../../lessons/01_basic/02_remote-and-github-basic.md)
-   ➡️ Thử thách thực hành: [Lab — Portfolio đầu tiên của bạn](../01_basic/lab_my-first-portfolio.md)

---

## 📌 Nhật ký thay đổi (Changelog)

- **v2.0.0 (26/05/2026)** — Bộ 4 câu hỏi tự đánh giá nền tảng Git: Staging Area, Untracked vs Modified, commit message, mô hình phân tán.
