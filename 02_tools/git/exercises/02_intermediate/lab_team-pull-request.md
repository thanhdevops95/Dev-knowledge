...
> **Cập nhật:** 10/06/2026\
> **Độ khó:** 🟡\
> **Yêu cầu trước:** Đã học xong bài [Quy trình làm việc nhóm](../../lessons/02_intermediate/02_collaborative-workflows.md) ✅
...
- **Châm ngôn:** "Measure twice, cut once" (Đo hai lần, cắt một lần)
EOF
```
...
-   ➡️ Thử thách tiếp theo (Cấp độ Nâng cao): [Quy tắc undo và sửa sai](../../lessons/03_advanced/00_undo-and-recovery.md) — Sửa chữa các sai lầm nguy hiểm.

---

## 📌 Nhật ký thay đổi (Changelog)

- **v2.1.0 (26/05/2026)** — Lab quy trình Pull Request & Code Review: tạo nhánh feature, push, tạo PR, đóng vai senior review + squash-merge, đồng bộ về local.
- **v2.1.1 (10/06/2026)** — Gỡ tên tác giả khỏi thân bài; bỏ field "Thời gian ước tính" (theo quy ước bỏ ước tính thời gian toàn kho); đổi `Prerequisites` → `Yêu cầu trước`, link text theo tiêu đề bài.
