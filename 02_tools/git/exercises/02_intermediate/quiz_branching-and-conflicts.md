...
## 🎯 Hướng dẫn làm bài
Đọc kỹ từng câu hỏi tình huống dưới đây, tự suy nghĩ đưa ra phương án giải quyết của riêng mình, sau đó click vào phần **💡 Xem giải thích** để so sánh và mở rộng tư duy lập trình chuyên nghiệp.
...
-   ⬅️ Quay lại bài học: [Giải quyết xung đột gộp code](../../lessons/02_intermediate/01_resolving-conflicts.md)
-   ➡️ Thử thách thực hành: [Lab — Người hùng gỡ Merge Conflict](../02_intermediate/lab_conflict-hero.md)

---

## 📌 Nhật ký thay đổi (Changelog)

- **v2.0.0 (26/05/2026)** — Bộ 4 câu hỏi tự đánh giá Git trung cấp: fast-forward vs three-way merge, cơ chế HEAD, conflict khi pull, quy ước đặt tên nhánh.
- **v2.0.1 (10/06/2026)** — Chuẩn hoá xưng hô: gỡ tên tác giả khỏi thân bài; link text điều hướng theo tiêu đề bài đích.
