...
main() {
    ...
    check_pass "OS: $os_name $os_version"
    echo ""
    ...
    if command -v brew &> /dev/null; then
        ...
        check_pass "Homebrew: version $brew_version"
    else
        check_fail "Homebrew: Not installed"
        check_fail "Install from: https://brew.sh"
        all_passed=false
    fi
    echo ""
    ...
    if command -v code &> /dev/null; then
        ...
        check_fail "Install VS Code and run 'Shell Command: Install code'"
        all_passed=false
    fi
    echo ""
