...
| Hướng | Bài |
|---|---|
| ⬅️ Bài trước | [../01_basic/02_remote-and-github-basic.md](../01_basic/02_remote-and-github-basic.md) — Kết nối GitHub |
| ➡️ Bài tiếp | [01_resolving-conflicts.md](./01_resolving-conflicts.md) — Giải quyết xung đột gộp code |
