...
## 3️⃣ Cách mở terminal (HOW)

| Hệ điều hành | Cách mở |
|---|---|
| **macOS** | `Cmd + Space` → gõ "Terminal" → Enter. Hoặc cài [iTerm2](https://iterm2.com/) (đẹp hơn). Sâu hơn: xem [setup/terminal-apps.md](../../setup/terminal-apps.md) (chưa có) |
...
| 🛠️ Setup terminal app | [setup/terminal-apps.md](../../setup/terminal-apps.md) — cài iTerm2/Warp + zsh (chưa có) |
