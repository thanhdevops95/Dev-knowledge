...
*   **v1.0.0 (16/05/2026)** — Phiên bản đầu tiên: giới thiệu các tùy chọn cài đặt Python, venv, pip cơ bản.
*   **v2.0.0 (26/05/2026)** — Bổ sung ẩn dụ nguồn nước cho `venv`; chuyển các tiêu đề H2 thành câu hỏi mở; chuẩn hóa định dạng cảnh báo (Alerts); Việt hóa comment trong code và đánh số rõ các bước hướng dẫn.
