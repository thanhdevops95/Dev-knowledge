...
| ⚓ [`gitops/`](./gitops/) | ✅ 1 bài | GitOps Basics: Định nghĩa, mô hình Pull vs Push. Phần thực hành chuyên sâu (ArgoCD) nằm trong CI/CD Intermediate. |
...
| Nhu cầu | Lộ trình đọc đề xuất |
|---|---|
| **Mới bắt đầu, muốn nắm bức tranh toàn cảnh** | Đọc `00_overview.md` trước. Sau đó bắt đầu học từ **Docker Basic** → **CI/CD Basic** → **IaC Basic** → **Kubernetes Basic** → **Observability Basic**. |
| **Muốn tự deploy và viết pipeline cho ứng dụng** | Tập trung vào **Docker Basic/Intermediate** + **CI/CD Basic** để có khả năng tự deploy và viết pipeline tự động. |
| **Cần kiến thức thiết kế ở quy mô Production** | Skim nhanh các bài Basic, rồi tập trung tối đa vào phần **Intermediate** của **IaC**, **Kubernetes** và **Observability**. |
...
- **v1.0.0 (26/05/2026)** — Hoàn thiện toàn bộ L2 core, cập nhật mục lục chi tiết chứa đầy đủ các lộ trình Basic và Intermediate.
