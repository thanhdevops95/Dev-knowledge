...
> **Knowledge Check for DevOps Interview Concepts**
>
> *Kiểm tra kiến thức phỏng vấn DevOps.*
...
<details>
<summary>Click to view / Nhấn để xem</summary>

| Q | A | Explanation |
|---|---|-------------|
| 1 | b | Framework for behavioral questions |
| 2 | b | Focus on professional journey |
| 3 | b | Honesty + problem-solving approach |
| 4 | b | Continuous Integration / Delivery or Deployment |
| 5 | b | Zero-downtime deployment strategy |
...
|------------|---------|--------|
| [README](./README.md) | **Quiz** | [LABS](./LABS.md) |
