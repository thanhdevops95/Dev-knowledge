...
### Cài đặt metrics-server (điều kiện tiên quyết)
...
### Karpenter (AWS-native, phổ biến 2026)
...
## 4️⃣ KEDA — Autoscaling theo sự kiện
...
### Ví dụ: Scale worker theo queue RabbitMQ
...
## 7️⃣ Hands-on: Viết operator đơn giản với Kubebuilder
...
### Định nghĩa spec (api/v1/echo_types.go)
...
### Viết logic reconcile (internal/controller/echo_controller.go)
...
### Point-in-time recovery (khôi phục về thời điểm)
