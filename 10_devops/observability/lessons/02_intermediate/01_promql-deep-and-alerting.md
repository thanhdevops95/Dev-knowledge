...
- alert: ErrorBudgetBurnFast
  expr: |
    (
      ...
      /
      sum(rate(http_requests_total[5m]))
    ) > (14.4 * 0.001)              # 14.4x normal rate → burn ~2% budget in 1h
    and
    (
...
- **v2.0.2 (13/06/2026)** — Sửa lỗi math: burn rate 14.4x trong cửa sổ 1h tiêu **~2%** error budget (30 ngày), không phải 5% (5% là của rule 6x/6h).
