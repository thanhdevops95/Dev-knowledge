...
## 2️⃣ OpenTelemetry — Standard 2026
...
### Even simpler — Auto-instrumentation
...
### Why Collector (vs ship direct to backend)?
...
## 7️⃣ Tempo, Jaeger, Honeycomb — Backends
...
## 8️⃣ Correlate traces ↔ logs ↔ metrics
...
### Exemplars — Trace from Prometheus
...
### PII — Don't include in attributes
