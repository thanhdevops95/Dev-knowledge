...
### Cấu hình backend trong project chính
...
## 3️⃣ State locking — Cách hoạt động
...
### Remove — gỡ khỏi state, không xoá trên cloud
...
### Pull / Push — tải xuống / tải lên state
...
### Cách 2 — `import` block (hiện đại, Terraform 1.5+)
...
## 7️⃣ Khôi phục khi state hỏng

### Tình huống 1 — State file bị hỏng
...
### Tình huống 2 — Resource bị xoá bên ngoài
...
### Tình huống 3 — Force unlock + state cũ
...
## 8️⃣ Workspaces — Tách môi trường gọn nhẹ
