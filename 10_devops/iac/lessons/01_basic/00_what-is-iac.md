...
### Declarative — Khai báo CÁI GÌ (Terraform, K8s)
...
### Imperative — Chỉ rõ LÀM THẾ NÀO (bash, AWS CLI)
...
## 4️⃣ Landscape 2026 — Các công cụ
...
### Config Management — Cấu hình **existing servers**
...
### Container Orchestration — Điều phối **containers**
...
### Luồng làm việc Terraform/OpenTofu
