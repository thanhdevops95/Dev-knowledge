...
## 1️⃣ Progressive delivery — Khái niệm

### Truyền thống vs Progressive
...
## 2️⃣ Argo Rollouts vs các tool khác
...
## 3️⃣ Rollout CRD — Thay thế Deployment
...
### Nhiều metric trong một analysis
...
## 7️⃣ Feature flags — Điều khiển lúc runtime
...
### OpenFeature SDK — Trung lập với vendor
...
### Bước 1: Cài Prometheus + ServiceMonitor
...
### Bước 3: Rollout với canary + analysis
...
### Kết hợp cả hai (đa số production)
