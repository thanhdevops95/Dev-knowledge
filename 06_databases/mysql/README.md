...
> 🚧 *Folder này chưa có content. Trong thời gian chờ, nền tảng SQL chung có thể học ở [sql-fundamentals](../sql-fundamentals/) — MySQL dùng chung 90% cú pháp SQL.*
...
├── 00_overview.md     ← \"mysql là gì\" — intro chung
