...
> 🚧 *Folder này chưa có content. Trong thời gian chờ, phần `pgvector` trong [JSONB & Arrays (PostgreSQL)](../postgresql/lessons/01_basic/03_jsonb-and-arrays.md) giới thiệu vector embedding trên Postgres.*
...
├── 00_overview.md     ← \"vector-databases là gì\" — intro chung
