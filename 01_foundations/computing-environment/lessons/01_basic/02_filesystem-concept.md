...
- **v1.1.0 (24/05/2026)** — Apply Blueprint v0.5.4. Thêm 4 lead-in trước bảng (filesystem 3 OS, Absolute vs Relative, 5 ký hiệu, file ẩn), bổ sung ✅ Best practice thứ 2 (tránh save trên Desktop), mở rộng giải thích `.gitignore` rõ hơn.
