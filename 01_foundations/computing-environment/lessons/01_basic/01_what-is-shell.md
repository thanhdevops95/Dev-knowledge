...
### ❌ Cạm bẫy: Viết script `.sh` bằng fish syntax
...
### ❌ Cạm bẫy: Quên `source` sau khi sửa `.zshrc`
...
### ❌ Cạm bẫy: Đổi default shell trên server production
...
- **v1.1.0 (24/05/2026)** — Thêm 2 lead-in trước bảng so sánh + bảng khuyến nghị, mở rộng ẩn dụ "người phiên dịch" sang section 2 (tại sao có nhiều shell), thêm lead-in cho 3 Pitfall + bổ sung ✅ Best practice thứ 2 (tách config theo loại).
