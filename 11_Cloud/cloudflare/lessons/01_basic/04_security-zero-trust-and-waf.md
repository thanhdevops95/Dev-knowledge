...
## 1️⃣ Cloudflare Security stack — overview
...
### Custom Rules — expression syntax
...
### Managed Rulesets — Cloudflare maintain
...
### Cloudflare Access — SSO + per-app authorization
...
### Cloudflare Gateway — DNS + HTTP filter outbound
...
## 7️⃣ mTLS — Client certificate authentication
...
## 8️⃣ Turnstile — CAPTCHA-free alternative
...
### Bước 8 — Turnstile cho form contact (optional)
