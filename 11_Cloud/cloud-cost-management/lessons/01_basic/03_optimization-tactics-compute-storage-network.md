...
> **Prerequisites:** [02_tagging-allocation-and-showback.md](02_tagging-allocation-and-showback.md)
...
### ❌ Pitfall: Tắt resource production lúc 2h sáng
...
### ❌ Pitfall: Apply Compute Optimizer mù
...
### ❌ Pitfall: Delete EBS snapshot không có AMI backup
...
### ❌ Pitfall: Đổi RDS sang Aurora Serverless v2 cho prod 24/7 steady
...
### Trong cluster
- ↶ Trước: [02_tagging-allocation-and-showback.md](02_tagging-allocation-and-showback.md)
- → Tiếp: [04_finops-tools-and-automation.md](04_finops-tools-and-automation.md)
- ↑ Cluster: [Cloud Cost Management README](../../README.md)

### Cross-reference
- ☁️ [AWS EC2 + EBS](../../../aws/lessons/01_basic/01_ec2-and-ebs-compute.md) — Compute context
- ☁️ [AWS S3 deep](../../../aws/lessons/01_basic/02_s3-deep-and-iam.md) — S3 + lifecycle
- ☁️ [AWS RDS + DynamoDB](../../../aws/lessons/01_basic/03_rds-and-dynamodb.md) — DB context
