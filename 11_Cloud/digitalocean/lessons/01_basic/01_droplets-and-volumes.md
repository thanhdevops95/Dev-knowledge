...
> **Prerequisites:** [00_what-is-digitalocean-overview](00_what-is-digitalocean-overview.md) ✅, hiểu Linux cơ bản, SSH

> 🎯 *Bài 01 đi sâu **Droplet** (= VM của DO) và **Block Storage Volumes** (= disk attach). Bạn sẽ học: 8 loại CPU options, cloud-init metadata để bootstrap, Reserved IP để IP cố định, Volume để mở rộng disk, Snapshot/Image để backup. Hands-on: deploy FastAPI Droplet production-grade.*

## 🎯 Sau bài này bạn sẽ

- [ ] Hiểu **8 loại CPU** Droplet (Basic / Premium Intel / Premium AMD / General Purpose / CPU-Optimized / Memory-Optimized / Storage-Optimized / GPU)
...
## 2️⃣ 8 loại CPU Droplet — Chọn đúng size

DO chia Droplet thành **Shared CPU** và **Dedicated CPU** (premium).
...
### Trong cluster
- ↶ Trước: [00_what-is-digitalocean-overview](00_what-is-digitalocean-overview.md)
- → Tiếp: [02_spaces-object-storage-and-cdn](02_spaces-object-storage-and-cdn.md)
- ↑ Cluster DigitalOcean: [DigitalOcean README](../../README.md)

### Cross-reference
- ☁️ [AWS EC2 + EBS](../../../aws/lessons/01_basic/01_ec2-and-ebs-compute.md) — so sánh
- 🐧 [Linux basics](../../../../03_Programming/linux/) — SSH, systemd, ufw
- 🐍 [FastAPI](../../../../07_Web/backend/python-fastapi/) — app stack
