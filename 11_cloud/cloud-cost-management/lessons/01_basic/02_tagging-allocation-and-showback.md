...
→ Khi resource này $146/tháng, FinOps biết ngay: prod / team backend / service checkout-api / cost center 1001 / owner An Nguyễn.
...
### ❌ Cạm bẫy: Tag value tự do, không enum
...
### ❌ Cạm bẫy: Tag retrofit thủ công cho 5000+ resource
...
### ❌ Cạm bẫy: 100+ tag không trục rõ ràng
...
- **Cách áp dụng**: `owner=an.nguyen@acmeshop.vn` hoặc `owner=team-backend` (cho shared team resource).
...
- ⬅️ **Bài trước:** [Pricing Models — On-demand / Reserved / Spot / Savings Plans](01_pricing-models-deep.md)
- ➡️ **Bài tiếp theo:** [Optimization Tactics — Compute / Storage / Network / Database](03_optimization-tactics-compute-storage-network.md)
