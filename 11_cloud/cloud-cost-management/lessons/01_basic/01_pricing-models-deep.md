...
> **Prerequisites:** [00_what-is-finops-overview.md](00_what-is-finops-overview.md)
...
| **GCP** | Spot VM | 60-91% | 30 giây | 24h (legacy "Preemptible") |
...
→ **Đúng**: Sau **3 năm** bạn save $1,011. Nếu giữa chừng (vd: 18 tháng) bạn migrate đi: $1,512 đã trả nhưng usage chỉ tương đương $1,261 on-demand → **lỗ $251**.
...
### ❌ Pitfall: Mua RI 3-year cho instance type sẽ thay đổi
...
### ❌ Pitfall: Bật cross-region replication mọi S3 bucket
...
### ❌ Pitfall: 1 NAT Gateway/AZ mọi VPC
...
Tính: $1,512 / $70.08/tháng = 21.6 tháng. Sau tháng 22, mọi tháng tiếp = pure saving.

Nhưng tính theo "saving so với on-demand cùng kỳ":
- 3 năm on-demand: $70.08 × 36 = $2,523.
- 3 năm RI: $1,512.
- Total saving: $1,011 → mỗi tháng "saving virtual" $28.

Nếu cancel sau 18 tháng → on-demand cùng kỳ $1,261, đã trả $1,512 → lỗ $251.
...
### Trong cluster
- ↶ Trước: [00_what-is-finops-overview.md](00_what-is-finops-overview.md)
- → Tiếp: [02_tagging-allocation-and-showback.md](02_tagging-allocation-and-showback.md) — Tagging + chargeback
