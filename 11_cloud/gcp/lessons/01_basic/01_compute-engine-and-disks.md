...
- VM **Spot** (giá rẻ, có thể bị reclaim bất cứ lúc nào với cảnh báo ~30s, KHÔNG có giới hạn thời gian chạy; preemptible đời cũ thì luôn bị dừng sau 24h).
- GPU instances.
...
| **Spot VM** | −60-91% | Workload chịu được interrupt bất cứ lúc nào (~30s notice) |
...
- **v2.0.3 (13/06/2026)** — Sửa lỗi factual: Spot VM KHÔNG có giới hạn 24h (chỉ preemptible đời cũ mới luôn dừng sau 24h); Spot bị reclaim bất cứ lúc nào với ~30s notice (sửa §5 + bảng §6).
