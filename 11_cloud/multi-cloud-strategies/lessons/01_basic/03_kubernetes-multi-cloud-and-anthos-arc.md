...
### Mapping mức độ portable theo layer
...
### Nguyên tắc để workload portable
...
### Phương án 1: Google Anthos (cao cấp, trưởng thành)
...
### Phương án 2: Azure Arc (đối trọng từ Microsoft)
...
### Phương án 4: Cluster API (CAPI) — mã nguồn mở, trung lập vendor
...
### Phương án 5: Rancher (SUSE) — mạnh về giao diện
...
### Phương án 6: Karmada — lập lịch xuyên cluster
...
### Phương án 1: Istio multi-primary
...
### Phương án 2: Cilium ClusterMesh
...
### Phương án 3: Linkerd multi-cluster
...
### Values riêng theo từng cluster
...
### Gotcha 1: Khác biệt storage class
...
### Gotcha 4: Hành vi ingress controller
...
## 7️⃣ Cây quyết định chọn pattern cho Acme Shop
