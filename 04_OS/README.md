...
Hệ điều hành: Linux, MacOS, Windows + cross-platform concepts. Đây là **chỗ canonical cho lệnh OS** (POSIX commands, PowerShell, ...) — `02_Tools/shell/` chỉ chứa shell-tool features.
